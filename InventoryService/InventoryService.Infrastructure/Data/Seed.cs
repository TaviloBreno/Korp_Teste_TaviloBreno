...
namespace InventoryService.Infrastructure.Data
{
    public static class Seed
    {
        public static async Task SeedDataAsync(InventoryDbContext context)
        {
            ...
            {
                new Product(product1Id, "SKU-001", "Notebook Dell Inspiron 15", 50),
                new Product(product2Id, "SKU-002", "Mouse Logitech MX Master 3", 200),
                new Product(product3Id, "SKU-003", "Teclado Mecânico RGB", 75),
                new Product(product4Id, "SKU-004", "Monitor LG 27'' 144Hz", 30),
                new Product(product5Id, "SKU-005", "Webcam HD 1080p", 120),
                new Product(product6Id, "SKU-006", "Headset Gamer HyperX Cloud", 45),
                new Product(product7Id, "SKU-007", "SSD NVMe 1TB", 85),
                new Product(product8Id, "SKU-008", "Memória RAM 16GB DDR4", 60),
                new Product(product9Id, "SKU-009", "Mousepad Grande", 150),
                new Product(product10Id, "SKU-010", "Hub USB 3.0 7 Portas", 40),
            };
